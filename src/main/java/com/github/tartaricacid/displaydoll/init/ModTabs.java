...
public interface ModTabs {
    DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, DisplayDoll.MOD_ID);

    DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN_TAB = TABS.register("displaydoll", () -> CreativeModeTab.builder()
            .title(Component.translatable("item_group.displaydoll"))
