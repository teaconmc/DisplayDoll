...
import com.github.tartaricacid.displaydoll.network.payload.SetPlayerDollDataPackage;
...
public class PlayerDollScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(font, Component.translatable("gui.displaydoll.player_doll.player_id"),
                this.playerId.getX() + 2, this.playerId.getY() - 10, color);

        graphics.text(font, Component.translatable("gui.displaydoll.player_doll.short_content"),
