package com.github.tartaricacid.displaydoll.client.model;
...
import com.github.tartaricacid.displaydoll.client.bedrock.AbstractBedrockModel;
...
public class PlayerDollModel extends AbstractBedrockModel<Unit> {
    private static final Identifier WIDE_DEFAULT = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/wide/default.json");
    private static final Identifier WIDE_CASUAL_WAVE = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/wide/casual_wave.json");
    private static final Identifier WIDE_CHEER = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/wide/cheer.json");
    private static final Identifier WIDE_PERFECT_BALANCE = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/wide/perfect_balance.json");
    private static final Identifier WIDE_SHY_POSE = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/wide/shy_pose.json");
    private static final Identifier WIDE_ZOMBIE = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/wide/zombie.json");

    private static final Identifier SLIM_DEFAULT = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/slim/default.json");
    private static final Identifier SLIM_CASUAL_WAVE = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/slim/casual_wave.json");
    private static final Identifier SLIM_CHEER = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/slim/cheer.json");
    private static final Identifier SLIM_PERFECT_BALANCE = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/slim/perfect_balance.json");
    private static final Identifier SLIM_SHY_POSE = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/slim/shy_pose.json");
    private static final Identifier SLIM_ZOMBIE = Identifier.fromNamespaceAndPath(DisplayDoll.MOD_ID, "models/bedrock/slim/zombie.json");
